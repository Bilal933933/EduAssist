...
from app.modules.lesson_knowledge.application.agent.tools import execute_tool, format_search_observation
from app.modules.lesson_knowledge.application.agent.prompts import AGENT_SYSTEM_FC
from app.modules.lesson_knowledge.application.agent.fc_client import call_with_tools, call_simple, MODEL_NAME, types as fc_types
...
def run_agentic_rag(client, kb, question, history=None, max_iterations=4, analysis=None, teacher_id="default", light=False):
    ...
    if analysis is None:
        try:
            ...
            from app.modules.lesson_knowledge.application.agent.clarifier import needs_clarification
    ...
    try:
        from app.modules.lesson_knowledge.application.agent.critic import judge_and_filter
        from app.modules.lesson_knowledge.application.agent.decomposer import get_pillars
